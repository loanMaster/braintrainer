export default {
  ...
  'voices-memory': {
    title: 'Voice memory',
    description: 'Just pay attention to the voice ignore the content!',
    hint: 'Look for pairs with identical speakers. Ignore the content, just pay attention to the voices! The exercise works like ordinary memory - only with audio.',
  },
  'picture-memory': {
    title: 'Picture memory',
    description: 'Memory as you know it',
