<template>
  <div class="g-game-container text-center pb-2">
    <h1 class="mt-4">{{ $t('Documentation') }}</h1>
    <h5 class="mt-2">{{ $t('What is BrainTrainer?') }}</h5>
    {{ $t('What is BrainTrainer?_answer') }}
    ...
    {{ $t('What do the stars and medals mean?_answer') }}

    <h5 class="mt-2">{{ $t('How does the daily training work?') }}</h5>
    {{ $t('How does the daily training work?_answer') }}

    <h5 class="mt-2">{{ $t('How can I report a bug?') }}</h5>
